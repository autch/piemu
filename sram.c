...
void sram_init(PIEMU_CONTEXT* context)
{
    /* メモリ割り当て。 */
...
int sram_read(PIEMU_CONTEXT* context, unsigned ofs, int size)
{
...
void sram_write(PIEMU_CONTEXT* context, unsigned ofs, int data, int size)
{
    ofs &= context->sram.mem_size - 1;
    switch (size) {
    case 1:
